...
let startCoord = (x: 5.1, y: 8.3)
let endCoord = (x: 375, y: 667)

let money: = (type: "usd", value: 1.00)

let cad_money = (type: "cad", value: money.value * 1.29)
let aus_money = (type: "usd", value: money.value * 1.23)

print("\(money.value) \(money.type) is \(cad_money.value) \(cad_money.type0")
