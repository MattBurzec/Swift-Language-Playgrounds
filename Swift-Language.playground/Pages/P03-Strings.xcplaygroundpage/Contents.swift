...
// Type your code here: 
var adjective: String = "terrible"
var location: String = "Chicago"
var animals: String = "Bear"
var name: String = "Matthew"
var musicGenre: String = "Poetry"
var verb: String = "running"

print("I adore \(adjective) walks on the \(location) with my pet \(animals), named \(name). We enjoy singing \(musicGenre) music while we \(running) together.")
