...
instructors["Matt"] = "Burzec"
instructors["Kobe"] = "Bryant"
instructors["Igo"] = "Poland"

print(instructors["Matt"]!)
print(instructors["Kobe"]!)

if instructors["Matt"] != nil {
    print(instructors["Matt"])
}

var track: [String: String] = [:]

track["apps"] = "Matt Burzec", "Kobe Bryant", "Igo Poland"

if let apps = track["apps"] {
    print(apps)
}
