...
getArea(height: 8, width: 9)

func getPerimeter(side1: Int, side2: Int) {
    return (side1 *  2 * side2 * 2)
}
func getPerimeterOfFloor(length: [Int]) -> Int {
...
getPerimeterOfFloor(length: [3, 4, 32, 432, 2])

var instructors = ["Matt", "LeBron", "Kobe"]
